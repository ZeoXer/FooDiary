...
const recommendationController = {
    ...
    generateRecommendation: async (req, res) => {
        ...
        if (!whichMeal || !mealTime || !Array.isArray(foodContent) || foodContent.length === 0) {
        ...
        try {
            ...
            return res.status(500).json({ success: false, message: "Generate recommendation failed: " + err.message });
        }
    }
};
